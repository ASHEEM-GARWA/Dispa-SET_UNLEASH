...
inputs,results = ds.get_sim_results(path="D:\Dispa-SET_UNLEASH\Simulations\(2)_BE_NBGx3.5",cache=False)

# if needed, define the plotting range for the dispatch plot:
import pandas as pd
rng = pd.date_range(start='2024-01-01',end='2024-01-07',freq='h')
